(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.XRegExp = factory());
})(this, function () {
  'use strict';
  /*!
   * XRegExp
  ...
  var build = XRegExp => {
    ...
    XRegExp.tag = flags => function (literals) {
    ...
    XRegExp.build = (pattern, subs, flags) => {
      ...
      var output = patternAsRegex.source.replace(parts, ($0, $1, $2, $3, $4) => {
        var subName = $1 || $2;
        var capName;
        var intro;
        ...
        if (subName) {
          ...
          var rewrittenSubpattern = data[subName].pattern.replace(subParts, (match, paren, backref) => {
            // Capturing group
            if (paren) {
